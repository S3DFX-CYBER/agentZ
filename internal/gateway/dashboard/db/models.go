...
type DashboardLatestRecord struct {
	TenantNamespace string    `json:"tenant_namespace"`
...
type DashboardPublishIdempotency struct {
	TenantNamespace string    `json:"tenant_namespace"`
	AgentName       string    `json:"agent_name"`
...
type DashboardPublishWindow struct {
	TenantNamespace string    `json:"tenant_namespace"`
	AgentName       string    `json:"agent_name"`
...
type DashboardQueryLease struct {
	Token           uuid.UUID `json:"token"`
	TenantNamespace string    `json:"tenant_namespace"`
	ExpiresAt       time.Time `json:"expires_at"`
}

type DashboardQueryWindow struct {
	TenantNamespace string    `json:"tenant_namespace"`
...
type DashboardTemporalRecord struct {
	ID              int64     `json:"id"`
	TenantNamespace string    `json:"tenant_namespace"`
	WidgetRevision  uuid.UUID `json:"widget_revision"`
